...
- 每个镜头都包含明确的 `CAMERA CHOREOGRAPHY`，规定起始构图、移动方向/幅度及轴线约束。
- 每个镜头边界都有自动决策：`CHAIN`、`RESET` 或首镜 `BASELINE`。
- `CHAIN`：动作、姿态或同一机位表演连续；必须把上一镜真实末帧作为本镜 First Frame，并在提示词指定的摄影机运动中平滑离开该起点。
- `RESET`：有意切换说话者、角度或构图；不得把上一镜末帧作为 First Frame。改用本镜构图图，并继续锁定角色、服装、场景、道具、灯光、屏幕方向和轴线。
- `transition_from_previous` 记录决策、原因、置信度和 First Frame 输入路径，便于自动化执行和审计。
...
- Duration: `3s`
- Boundary decision: **BASELINE** (confidence `1.00`) — Opening shot establishes the continuity baseline.
...
This is the continuity baseline shot. Establish stable character identities, wardrobe, seating, camera axis, furniture, props, city background and warm/cool lighting for later shots. Use this shot’s staging image as the opening composition reference. Preserve a stable final 0.3–0.5 seconds as a usable continuity handle for Shot 002 only if Shot 002 is later classified CHAIN; otherwise retain it as an editorial handle.
...
- Duration: `2s`
- Boundary decision: **RESET** (confidence `0.95`) — Intentional cut from the ensemble master to a tighter three-shot; exact pose matching would block the new composition.
- References to upload (exact order):
...
IDENTITY AND CONTINUITY:
Use the character portrait reference images in the Reference Map to lock each visible actor’s face, hairstyle, skin tone, wardrobe and body proportions. Never swap, merge, duplicate or replace identities. Keep every actor on the assigned side of the axis and in the assigned seat. This is a deliberate camera reset: preserve world/identity continuity, but use this shot’s staging image for the new opening composition rather than matching the previous final pose. Use this shot’s JPG as the first-frame identity/composition reference. Lock character faces, hair, wardrobe, body proportions, seating side, eyelines, table/card/snack-plate positions, city-night background, and warm/cool lighting to the source JPG and adjacent shots. Do not animate storyboard labels or subtitles: remove/crop/clean all labels and caption bands before image-to-video; composite exact Chinese dialogue or final card afterward in editing.

BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Intentional cut from the ensemble master to a tighter three-shot; exact pose matching would block the new composition. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 003.
...
- Duration: `1s`
- Boundary decision: **RESET** (confidence `0.95`) — Reverse-angle speaker change to Liu; reset composition while preserving screen direction and scene identity.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Reverse-angle speaker change to Liu; reset composition while preserving screen direction and scene identity. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 004.
...
- Duration: `3s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut back to the three-friend group and a new speaker emphasis.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut back to the three-friend group and a new speaker emphasis. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 005.
...
- Duration: `1s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut to the Liu/Ito two-shot for the punchline; a new composition is intentional.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut to the Liu/Ito two-shot for the punchline; a new composition is intentional. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 006.
...
- Duration: `4s`
- Boundary decision: **CHAIN** (confidence `0.96`) — Same speaker, two-shot and explanatory action continue directly from Shot 005.
- First Frame input: `rendered/shot_005_final_frame.png`
- References to upload (exact order):
...
IDENTITY AND CONTINUITY:
Use the character portrait reference images in the Reference Map to lock each visible actor’s face, hairstyle, skin tone, wardrobe and body proportions. Never swap, merge, duplicate or replace identities. Keep every actor on the assigned side of the axis and in the assigned seat. For CHAIN shots, preserve the supplied previous final frame at the opening and continue without a pose reset. Use this shot’s JPG as the first-frame identity/composition reference. Lock character faces, hair, wardrobe, body proportions, seating side, eyelines, table/card/snack-plate positions, city-night background, and warm/cool lighting to the source JPG and adjacent shots. Do not animate storyboard labels or subtitles: remove/crop/clean all labels and caption bands before image-to-video; composite exact Chinese dialogue or final card afterward in editing.

BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: CHAIN (confidence 0.96). Continuity is required because Same speaker, two-shot and explanatory action continue directly from Shot 005. Use the literal final rendered frame of Shot 005 as this shot’s First Frame input. The opening must continue from that frame without a pose, expression, prop, lighting, screen-direction or camera-axis reset. Begin with the supplied composition, then execute the CAMERA CHOREOGRAPHY below smoothly so camera movement does not break identity or action continuity. If First Frame cannot be combined with the required references, do not silently approximate: mark this shot for continuity review and use the fixed staging, setting and character references only as a fallback. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 007.
...
- Duration: `2s`
- Boundary decision: **CHAIN** (confidence `0.91`) — Immediate reaction in the same two-person setup; preserve Ito’s settled pose and Liu’s rising discomfort.
- First Frame input: `rendered/shot_006_final_frame.png`
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: CHAIN (confidence 0.91). Continuity is required because Immediate reaction in the same two-person setup; preserve Ito’s settled pose and Liu’s rising discomfort. Use the literal final rendered frame of Shot 006 as this shot’s First Frame input. The opening must continue from that frame without a pose, expression, prop, lighting, screen-direction or camera-axis reset. Begin with the supplied composition, then execute the CAMERA CHOREOGRAPHY below smoothly so camera movement does not break identity or action continuity. If First Frame cannot be combined with the required references, do not silently approximate: mark this shot for continuity review and use the fixed staging, setting and character references only as a fallback. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 008.
...
- Duration: `2s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut away from the couple to the three-friend group for a new speaker and framing.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut away from the couple to the three-friend group for a new speaker and framing. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 009.
...
- Duration: `2s`
- Boundary decision: **CHAIN** (confidence `0.94`) — Same three-friend sofa setup; dialogue passes from Girlfriend A to B with a small lateral camera ease.
- First Frame input: `rendered/shot_008_final_frame.png`
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: CHAIN (confidence 0.94). Continuity is required because Same three-friend sofa setup; dialogue passes from Girlfriend A to B with a small lateral camera ease. Use the literal final rendered frame of Shot 008 as this shot’s First Frame input. The opening must continue from that frame without a pose, expression, prop, lighting, screen-direction or camera-axis reset. Begin with the supplied composition, then execute the CAMERA CHOREOGRAPHY below smoothly so camera movement does not break identity or action continuity. If First Frame cannot be combined with the required references, do not silently approximate: mark this shot for continuity review and use the fixed staging, setting and character references only as a fallback. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 010.
...
- Duration: `2s`
- Boundary decision: **CHAIN** (confidence `0.94`) — Same three-friend sofa setup; dialogue passes from Girlfriend B to C with a continuing lateral ease.
- First Frame input: `rendered/shot_009_final_frame.png`
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: CHAIN (confidence 0.94). Continuity is required because Same three-friend sofa setup; dialogue passes from Girlfriend B to C with a continuing lateral ease. Use the literal final rendered frame of Shot 009 as this shot’s First Frame input. The opening must continue from that frame without a pose, expression, prop, lighting, screen-direction or camera-axis reset. Begin with the supplied composition, then execute the CAMERA CHOREOGRAPHY below smoothly so camera movement does not break identity or action continuity. If First Frame cannot be combined with the required references, do not silently approximate: mark this shot for continuity review and use the fixed staging, setting and character references only as a fallback. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 011.
...
- Duration: `4s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut from the friend group to Jiboda’s reaction angle.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut from the friend group to Jiboda’s reaction angle. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 012.
...
- Duration: `5s`
- Boundary decision: **CHAIN** (confidence `0.97`) — Same speaker, axis and argument continue directly from Shot 011.
- First Frame input: `rendered/shot_011_final_frame.png`
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: CHAIN (confidence 0.97). Continuity is required because Same speaker, axis and argument continue directly from Shot 011. Use the literal final rendered frame of Shot 011 as this shot’s First Frame input. The opening must continue from that frame without a pose, expression, prop, lighting, screen-direction or camera-axis reset. Begin with the supplied composition, then execute the CAMERA CHOREOGRAPHY below smoothly so camera movement does not break identity or action continuity. If First Frame cannot be combined with the required references, do not silently approximate: mark this shot for continuity review and use the fixed staging, setting and character references only as a fallback. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 013.
...
- Duration: `5s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut from Jiboda to Liu’s reaction angle as anger rises.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut from Jiboda to Liu’s reaction angle as anger rises. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 014.
...
- Duration: `2s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut from Liu to the three-friend group reaction.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut from Liu to the three-friend group reaction. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 015.
...
- Duration: `3s`
- Boundary decision: **CHAIN** (confidence `0.93`) — Same three-friend setup and group reaction continue from Shot 014.
- First Frame input: `rendered/shot_014_final_frame.png`
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: CHAIN (confidence 0.93). Continuity is required because Same three-friend setup and group reaction continue from Shot 014. Use the literal final rendered frame of Shot 014 as this shot’s First Frame input. The opening must continue from that frame without a pose, expression, prop, lighting, screen-direction or camera-axis reset. Begin with the supplied composition, then execute the CAMERA CHOREOGRAPHY below smoothly so camera movement does not break identity or action continuity. If First Frame cannot be combined with the required references, do not silently approximate: mark this shot for continuity review and use the fixed staging, setting and character references only as a fallback. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 016.
...
- Duration: `3s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut from the friend group to Jiboda’s reply angle.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut from the friend group to Jiboda’s reply angle. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 017.
...
- Duration: `3s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut from Jiboda to Ito’s reply angle.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut from Jiboda to Ito’s reply angle. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 018.
...
- Duration: `6s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut back to Jiboda for the counterargument.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut back to Jiboda for the counterargument. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 019.
...
- Duration: `2s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut to Liu’s defensive reaction angle.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut to Liu’s defensive reaction angle. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 020.
...
- Duration: `2s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut back to Jiboda’s clean follow-up.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut back to Jiboda’s clean follow-up. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 021.
...
- Duration: `5s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut to Liu’s explanation angle.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut to Liu’s explanation angle. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 022.
...
- Duration: `3s`
- Boundary decision: **CHAIN** (confidence `0.88`) — Same seated pair and defensive explanation continue as Ito supports Liu’s statement.
- First Frame input: `rendered/shot_021_final_frame.png`
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: CHAIN (confidence 0.88). Continuity is required because Same seated pair and defensive explanation continue as Ito supports Liu’s statement. Use the literal final rendered frame of Shot 021 as this shot’s First Frame input. The opening must continue from that frame without a pose, expression, prop, lighting, screen-direction or camera-axis reset. Begin with the supplied composition, then execute the CAMERA CHOREOGRAPHY below smoothly so camera movement does not break identity or action continuity. If First Frame cannot be combined with the required references, do not silently approximate: mark this shot for continuity review and use the fixed staging, setting and character references only as a fallback. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 023.
...
- Duration: `3s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut from the couple to the three-friend group.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut from the couple to the three-friend group. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 024.
...
- Duration: `3s`
- Boundary decision: **CHAIN** (confidence `0.93`) — Same three-friend setup; the argument passes naturally from Girlfriend A to B.
- First Frame input: `rendered/shot_023_final_frame.png`
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: CHAIN (confidence 0.93). Continuity is required because Same three-friend setup; the argument passes naturally from Girlfriend A to B. Use the literal final rendered frame of Shot 023 as this shot’s First Frame input. The opening must continue from that frame without a pose, expression, prop, lighting, screen-direction or camera-axis reset. Begin with the supplied composition, then execute the CAMERA CHOREOGRAPHY below smoothly so camera movement does not break identity or action continuity. If First Frame cannot be combined with the required references, do not silently approximate: mark this shot for continuity review and use the fixed staging, setting and character references only as a fallback. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 025.
...
- Duration: `3s`
- Boundary decision: **CHAIN** (confidence `0.93`) — Same three-friend setup; the argument passes naturally from Girlfriend B to C.
- First Frame input: `rendered/shot_024_final_frame.png`
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: CHAIN (confidence 0.93). Continuity is required because Same three-friend setup; the argument passes naturally from Girlfriend B to C. Use the literal final rendered frame of Shot 024 as this shot’s First Frame input. The opening must continue from that frame without a pose, expression, prop, lighting, screen-direction or camera-axis reset. Begin with the supplied composition, then execute the CAMERA CHOREOGRAPHY below smoothly so camera movement does not break identity or action continuity. If First Frame cannot be combined with the required references, do not silently approximate: mark this shot for continuity review and use the fixed staging, setting and character references only as a fallback. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 026.
...
- Duration: `6s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut from the friend group to Jiboda’s extended rebuttal.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut from the friend group to Jiboda’s extended rebuttal. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 027.
...
- Duration: `4s`
- Boundary decision: **CHAIN** (confidence `0.98`) — Same speaker, framing and enumerated argument continue directly from Shot 026.
- First Frame input: `rendered/shot_026_final_frame.png`
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: CHAIN (confidence 0.98). Continuity is required because Same speaker, framing and enumerated argument continue directly from Shot 026. Use the literal final rendered frame of Shot 026 as this shot’s First Frame input. The opening must continue from that frame without a pose, expression, prop, lighting, screen-direction or camera-axis reset. Begin with the supplied composition, then execute the CAMERA CHOREOGRAPHY below smoothly so camera movement does not break identity or action continuity. If First Frame cannot be combined with the required references, do not silently approximate: mark this shot for continuity review and use the fixed staging, setting and character references only as a fallback. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 028.
...
- Duration: `3s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut to Liu’s angry reaction angle.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut to Liu’s angry reaction angle. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 029.
...
- Duration: `2s`
- Boundary decision: **RESET** (confidence `0.95`) — Cut back to Jiboda’s dry reply.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Cut back to Jiboda’s dry reply. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 030.
...
- Duration: `4s`
- Boundary decision: **CHAIN** (confidence `0.96`) — Same speaker and dry response continue directly from Shot 029.
- First Frame input: `rendered/shot_029_final_frame.png`
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: CHAIN (confidence 0.96). Continuity is required because Same speaker and dry response continue directly from Shot 029. Use the literal final rendered frame of Shot 029 as this shot’s First Frame input. The opening must continue from that frame without a pose, expression, prop, lighting, screen-direction or camera-axis reset. Begin with the supplied composition, then execute the CAMERA CHOREOGRAPHY below smoothly so camera movement does not break identity or action continuity. If First Frame cannot be combined with the required references, do not silently approximate: mark this shot for continuity review and use the fixed staging, setting and character references only as a fallback. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 031.
...
- Duration: `4s`
- Boundary decision: **CHAIN** (confidence `0.98`) — Same speaker, framing and concluding argument continue directly from Shot 030.
- First Frame input: `rendered/shot_030_final_frame.png`
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: CHAIN (confidence 0.98). Continuity is required because Same speaker, framing and concluding argument continue directly from Shot 030. Use the literal final rendered frame of Shot 030 as this shot’s First Frame input. The opening must continue from that frame without a pose, expression, prop, lighting, screen-direction or camera-axis reset. Begin with the supplied composition, then execute the CAMERA CHOREOGRAPHY below smoothly so camera movement does not break identity or action continuity. If First Frame cannot be combined with the required references, do not silently approximate: mark this shot for continuity review and use the fixed staging, setting and character references only as a fallback. Preserve a stable final 0.3–0.5 seconds as an editorial handle for Shot 032.
...
- Speaker/dialogue: **None**
- Duration: `3s`
- Boundary decision: **RESET** (confidence `0.95`) — Intentional reset to a wider ensemble reaction tableau for the ending.
- References to upload (exact order):
...
BEST-EFFORT SHOT-TO-SHOT CONTINUITY:
DECISION: RESET (confidence 0.95). Exact action/pose continuity from the previous final frame is not required because Intentional reset to a wider ensemble reaction tableau for the ending. Do NOT use the previous shot’s final frame as this shot’s First Frame. Use this shot’s staging image for the new composition and the fixed setting/character references to preserve world continuity: identity, wardrobe, furniture, props, lighting, screen direction and camera axis. The reset applies only to camera composition and exact pose; it does not permit character, wardrobe, set or prop redesign. Execute the CAMERA CHOREOGRAPHY below from the new staging composition.
